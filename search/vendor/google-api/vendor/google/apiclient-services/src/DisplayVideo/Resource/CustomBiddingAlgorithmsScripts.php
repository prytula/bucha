...
/**
 * The "cli" collection of methods.
 * Typical usage is:
 *  <code>
 *   $displayvideoService = new Google\Service\DisplayVideo(...);
 *   $cli = $displayvideoService->cli;
 *  </code>
 */
class CustomBiddingAlgorithmsScripts extends \Google\Service\Resource
{
  ...
  /**
   * Gets a custom bidding script. (cli.get)
   *
   * @param string $customBiddingAlgorithmId Required. The ID of the custom
  ...
  /**
   * Lists custom bidding cli that belong to the given algorithm. The order is
   * defined by the order_by parameter.
   * (cli.listCustomBiddingAlgorithmsScripts)
   *
   * @param string $customBiddingAlgorithmId Required. The ID of the custom
   * bidding algorithm owns the script.
   * @param array $optParams Optional parameters.
